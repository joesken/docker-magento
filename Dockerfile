...
RUN wget https://github.com/ysilvela/docker-magento/raw/master/magento-1.9.1.0.tar-2015-02-10-09-39-06.tar.zip
#RUN wget https://github.com/ysilvela/docker-magento/raw/master/magento-1.9.3.0-2016-10-11-06-05-14.tar.gz
RUN mv magento-1.9.1.0.tar-2015-02-10-09-39-06.tar.zip /tmp
#RUN mv magento-1.9.3.0-2016-10-11-06-05-14.tar.gz /tmp
RUN cd /tmp && tar -zxvf magento-1.9.1.0.tar-2015-02-10-09-39-06.tar.zip
